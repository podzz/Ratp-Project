...
<html lang="fr">
  ...
  <body>
    ...
    <script type="text/javascript">
      ...
      var stations = [
      { value: 'Balard', lines: [8]},
      { value: 'Bonne nouvelle', lines: [8, 9]},
      { value: 'Pointe du Lac', lines: [8] },
      { value: 'Félix Faure', lines: [8] },
                  { value: 'La Motte-Picquet - Grenelle', lines: [6,
      8, 10] },
      { value: 'École Militaire', lines: [8] },
      { value: 'La Tour-Maubourg', lines: [8] }];
